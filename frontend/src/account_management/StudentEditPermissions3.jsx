...
//
// NOTE: Fields that are already hardcoded as read-only in StudentDashboard3
//       (none in this step — all editable fields appear in the form) are
//       marked system: true.  Every TextField/Select the student sees that
//       is NOT disabled by default is marked system: false so the admin can
//       control it.
// ─────────────────────────────────────────────────────────────────────────────
const SECTIONS = [
  {
  ...
  },
  {
    ...
    fields: [
      { id: "strand", label: "SHS Strand / Track", system: false, defaultOn: true },
    ],
  },
];
...
const StudentEditPermissions3 = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: "Educational Attainment permissions saved successfully!",
        severity: "success",
      });
    } catch (err) {
    ...
    <Box sx={{ height: "calc(100vh - 150px)", overflowY: "auto", p: 2, backgroundColor: "transparent" }}>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 2, mb: 2 }}>
        <Box>
          ...
          >
            ...
            STUDENT EDIT PERMISSIONS — EDUCATIONAL ATTAINMENT
          </Typography>
          <Typography variant="body2" sx={{ color: "#666", mt: 0.5 }}>
            Control which fields students can modify in their{" "}
            <strong>Educational Attainment</strong> form (Step 3). Toggle a field
      ...
      >
        ...
        <Box sx={{ ml: "auto", display: "flex", alignItems: "center" }}>
          <SchoolIcon sx={{ color: mainButtonColor, mr: 1 }} />
...
export default StudentEditPermissions3;
