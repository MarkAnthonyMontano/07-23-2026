...
import { Button, Box, TextField, Container, Snackbar, Alert, Typography, Card, TableContainer, Paper, Table, TableHead, TableRow, TableCell, FormHelperText, FormControl, InputLabel, Select, MenuItem, Modal, FormControlLabel, Checkbox, IconButton } from "@mui/material";
            ...
            <Box display="flex" justifyContent="right" mt={4}>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  navigate(`/applicant_registrar_family_background?person_id=${userID}`);
